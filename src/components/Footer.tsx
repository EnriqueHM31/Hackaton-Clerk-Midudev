                ...
                >
                    <div className="flex items-center flex-col xl:flex-row gap-2 z-50">
                        <div className="flex items-center gap-2">
                            <img src="/src/assets/Logo.webp" alt="Logo" className="size-10" loading="lazy" />
                    ...
                    <div className="flex gap-3 xl:order-2 order-1 z-50">
                        <a
                            ...
                            href="/"><img src="/src/assets/IconFacebook.png" loading="lazy" alt="Icono para facebook" />
                        </a>
                        <a
                            className="size-10 rounded-full bg-black flex items-center justify-center hover:border-secondary transition-colors hover:shadow-secondary hover:shadow-lg border border-white/50"
                            href="/"><img src="/src/assets/IconLinkedin.png" loading="lazy" alt="Icono para linkedin" /></a>
                        <a
                            className="size-10 rounded-full bg-black flex items-center justify-center hover:border-secondary transition-colors hover:shadow-secondary hover:shadow-lg border border-white/50"
                            href="/"><img src="/src/assets/IconTwitter.png" loading="lazy" alt="Icono para twitter" /></a>
                        <a
                            className="size-10 rounded-full bg-black flex items-center justify-center hover:border-secondary transition-colors hover:shadow-secondary hover:shadow-lg border border-white/50"
                            href="/"><img src="/src/assets/IconYouTube.png" loading="lazy" alt="Icono para youtube" /></a>
                    </div>
                </div>
            </div>
        </footer>
