...
export default function CardPartipanteProyecto({ selected, setSelected, formatearFecha }: Props) {
    return (
        <div
            className="fixed inset-0 bg-gradient-to-t from-black/80 to-black/40 bg-opacity-70 flex items-center justify-center z-[100] xl:max-h-full  "
            onClick={() => setSelected(null)}
        >
            <div
                className=" text-black rounded-lg xl:max-w-5xl w-full relative"
            ...
            >
                ...
                <div className="relative rounded-lg bg-black p-2 w-full border border-pink-400 z-[100]">
                    <div className="relative flex text-center gap-6">
                        ...
                        <span className="absolute inset-x-0 top-2 text-white font-bold text-lg xl:text-4xl">{selected.nombre_proyecto}.tsx</span>
                    </div>
                    ...
                    <div className="mt-5 space-y-1.5 px-5 pb-10 text-4xl">
                        <p className="mt-4 font-mono text-xs font-normal tracking-wide text-violet-400">
                            ...
                            <span className="text-md xl:text-2xl text-pink-400">Proyecto</span>
                            <span className="text-md xl:text-2xl text-slate-500">&gt;</span>
                        </p>
                        <p className="ml-3 font-mono text-xs font-normal tracking-wide text-violet-400">
                            <span className="text-md xl:text-2xl text-slate-500">&nbsp;&lt;</span>
                            <span className="text-md xl:text-2xl text-pink-400">Username</span>
                            <span className="text-md xl:text-2xl text-slate-500">&gt;</span>
                            <span className="text-md xl:text-2xl relative inline-block px-1 before:absolute before:-inset-0.5 before:block before:rounded before:bg-blue-500/10">
                                <span className="text-md xl:text-2xl relative text-blue-400">{selected.username}</span>
                            </span>
                            <span className="text-md xl:text-2xl text-slate-500">;&lt;/</span>
                            <span className="text-md xl:text-2xl text-pink-400">Username</span>
                            <span className="text-md xl:text-2xl text-slate-500">&gt;</span>
                        ...
                        <p className="ml-3 font-mono text-xs font-normal leading-4 tracking-wide text-violet-400">
                            <span className="text-md xl:text-2xl text-slate-500">&nbsp;&lt;</span>
                            <span className="text-md xl:text-2xl text-pink-400">GitHub</span>
                        ...
                        <p className="ml-3 font-mono text-xs font-normal tracking-wide text-violet-400">
                            <span className="text-md xl:text-2xl text-slate-500">&nbsp;&lt;</span>
                            <span className="text-md xl:text-2xl text-pink-400">FechaEntrega</span>
                            <span className="text-md xl:text-2xl text-slate-500">&gt;</span>
                            <span className="text-md xl:text-2xl relative inline-block px-1 before:absolute before:-inset-0.5 before:block before:rounded before:bg-blue-500/10">
                                <span className="text-md xl:text-2xl relative text-blue-400">{formatearFecha(selected.joined_at)}</span>
                            </span>
                            <span className="text-md xl:text-2xl text-slate-500">&lt;/</span>
                            <span className="text-md xl:text-2xl text-pink-400">FechaEntrega</span>
                            <span className="text-md xl:text-2xl text-slate-500">&gt;</span>
